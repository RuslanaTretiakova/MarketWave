...
-- This status migration is performed in a separate post-enum migration to avoid
-- unsafe use of a newly added enum value within the same migration transaction.
