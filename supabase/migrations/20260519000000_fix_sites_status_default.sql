-- sites_enforce_sourcer_defaults was not updated when pending_review was
-- renamed to pending in 20260516120000_sites_status_enum_rename.sql.
-- The trigger tried to cast 'pending_review' to site_status on every sourcer
-- INSERT/UPDATE, failing with "invalid input value for enum site_status".
