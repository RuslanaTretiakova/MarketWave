...
export function ChatsToolbar({
  ...
  return (
    <div className={cn(className)}>
      <div className="px-section py-block gap-inset flex items-center">
        <button
      ...
      >
        <div className="px-section pb-block gap-inset flex flex-wrap items-end">
          ...
          {hasFilters ? (
            <Link
              ...
              className={cn(
                ...
                'h-8 gap-2 self-end rounded-full px-3 text-xs'
              )}
            >
